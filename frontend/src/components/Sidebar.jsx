...
export default function Sidebar({ modules, progress, reviewDue = 0 }) {
  ...
  return (
    <aside className="w-[220px] shrink-0 bg-gray-100 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col h-screen sticky top-0 overflow-y-auto">
