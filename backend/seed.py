    ...
    },
    {
        ...
        'modules': [
            {'slug': 'cicd', 'title': 'CI/CD Pipelines', 'lessons': [
                {'slug': 'github-actions', 'title': 'GitHub Actions', 'duration_min': 25, 'difficulty': 'intermediate'},
                {'slug': 'jenkins', 'title': 'Jenkins', 'duration_min': 20, 'difficulty': 'intermediate'},
                {'slug': 'argocd-gitops', 'title': 'ArgoCD & GitOps', 'duration_min': 25, 'difficulty': 'advanced'},
            ...
            {'slug': 'aws', 'title': 'AWS', 'lessons': [
                {'slug': 'ec2-s3-iam', 'title': 'EC2, S3 & IAM', 'duration_min': 30, 'difficulty': 'beginner'},
                {'slug': 'vpc-route53', 'title': 'VPC & Route53', 'duration_min': 25, 'difficulty': 'intermediate'},
                {'slug': 'eks', 'title': 'EKS — Managed Kubernetes', 'duration_min': 25, 'difficulty': 'advanced'},
                {'slug': 'lambda', 'title': 'Lambda', 'duration_min': 20, 'difficulty': 'intermediate'},
                {'slug': 'cost-management', 'title': 'Cost Management', 'duration_min': 15, 'difficulty': 'beginner'},
            ]},
            {'slug': 'gcp', 'title': 'GCP', 'lessons': [
                {'slug': 'compute-storage', 'title': 'Compute Engine & GCS', 'duration_min': 25, 'difficulty': 'beginner'},
                {'slug': 'gke', 'title': 'GKE — Managed Kubernetes', 'duration_min': 25, 'difficulty': 'advanced'},
            ...
            {'slug': 'monitoring', 'title': 'Monitoring (Datadog)', 'lessons': [
                {'slug': 'observability-pillars', 'title': 'Metrics, Logs & Traces', 'duration_min': 20, 'difficulty': 'beginner'},
    ...
    },
    {
        ...
        'modules': [
            {'slug': 'devsecops', 'title': 'DevSecOps', 'lessons': [
                {'slug': 'secrets-management', 'title': 'Secrets Management', 'duration_min': 20, 'difficulty': 'intermediate'},
                {'slug': 'container-security', 'title': 'Container Security', 'duration_min': 20, 'difficulty': 'intermediate'},
                {'slug': 'sast-dast', 'title': 'SAST & DAST Basics', 'duration_min': 15, 'difficulty': 'intermediate'},
                {'slug': 'iam-best-practices', 'title': 'IAM Best Practices', 'duration_min': 15, 'difficulty': 'intermediate'},
            ]},
            {'slug': 'postman', 'title': 'Postman / API Testing', 'lessons': [
                ...
                {'slug': 'collections-environments', 'title': 'Collections & Environments', 'duration_min': 15, 'difficulty': 'beginner'},
